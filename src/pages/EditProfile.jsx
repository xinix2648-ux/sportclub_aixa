        ...
        <div className="glass-card p-4 p-md-5">
          ...
          <Form onSubmit={handleSubmit}>
            <Row className="g-3 mb-4">
              <Col md={6}>
                <Form.Group>
                  ...
                  <Form.Control value={full_name} onChange={(e) => setFullName(e.target.value)} placeholder="Tu nombre" />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group>
            ...
            <Form.Group className="mb-4">
              <Form.Label className="small-text">Nueva contraseña (dejar vacío para mantener)</Form.Label>
              <Form.Control type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Mín. 8 caracteres" />
            </Form.Group>
